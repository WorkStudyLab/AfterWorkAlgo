...
[양태욱](https://github.com/didxodnr0769-bom) · [윤도운](https://github.com/yundoun) · [박희연](https://github.com/Park-Heeyeon) · [백승훈](https://github.com/zerosial) · [김권수](https://github.com/Kuneosu)
...
### 새로운 주차 시작 시
1. 해당 주차 폴더의 `README.md`에 주제와 문제 목록을 작성합니다
2. 각자 개인 폴더를 생성하고 문제를 풉니다
3. 소스코드를 개인 폴더에 업로드합니다

### 모임 후
1. 해당 주차의 `README.md`에 발표자와 스터디 내용을 기록합니다
